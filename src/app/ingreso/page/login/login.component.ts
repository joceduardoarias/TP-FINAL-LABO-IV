...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    private apEspecialista: AprobarEspecialistasService,
    private us: RegistrarUsuariosService,
    private ToastrSvc: ToastrService,
    private ingresos: LogIngresosService    
  ) {
        ...
        if (efe.perfil == 'paciente') {
          ...
          if (efe.estado == 'deshabilitado') {
            ...
            Swal.fire({
              ...
              icon: 'warning',
              title:
                'Cuenta deshabilitada temporalmente, habla con el administrador.',
